...
// SortWord takes a string and returns it with its characters in a sorted order
...
// ReverseSortWord takes a string and returns it with its characters in a reverse sorted order
